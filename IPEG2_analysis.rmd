...
sum((posterior_mu3[, "b_ORM_codeHTPHSP"] > 0))
sum(posterior_mu3[, "b_ORM_codeImagine"] > 0)
# Bayes factors
...
# Order restricted model 2
m2_NC<-(posterior_mu2_NC[, "b_ORM_codeImagine"] < 0) | (abs(posterior_mu2_NC[, "b_ORM_codeImagine"]) < 0.1))
